...
__codeTable__ = [
    ...
    compile('while currentPage in referenceQueues[0]:             referenceQueues[0].remove(currentPage)','nofile','exec'),
    compile('while currentPage in referenceQueues[1]:             referenceQueues[1].remove(currentPage)','nofile','exec'),
    compile('referenceQueues[isModified].append(currentPage)','nofile','exec'),
    ...
    compile('victimPage = (referenceQueues[0].pop(0))             if (len(referenceQueues[0]) > 0)             else (referenceQueues[1].pop(0))','nofile','exec'),
