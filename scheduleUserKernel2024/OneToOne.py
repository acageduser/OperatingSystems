            ...
            try:
                ...
                while not self.__isdead__:
                    ...
                    if self.state == 'init':
                        ...
                        if event == 'cpu':
                            if eval(__codeTable__[12],globals,locals):
                                self.logger.log(self, tag="DEPART")
                        ...
                        if event == 'cpu':
                            if eval(__codeTable__[17],globals,locals):
                                self.logger.log(self, tag="DEPART")
                                self.state = 'userMode'
                                self.logger.log(self, tag="APPROACH")
                                ...
                                continue
                        if event == 'cpu':
                            if eval(__codeTable__[20],globals,locals):
                                self.logger.log(self, tag="DEPART")
                                self.state = 'done'
                                self.logger.log(self, tag="APPROACH")
                                self.logger.log(self, tag="ARRIVE")
...
__codeTable__ = [
    ...
    compile('False','nofile','eval'),
    compile('cpu(1)','nofile','exec'),
